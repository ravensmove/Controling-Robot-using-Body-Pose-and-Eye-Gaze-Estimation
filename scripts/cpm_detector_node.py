...
class CPM(object):
    ...
    def __init__(self):
        ...
        self.image_sub_topic_name = rospy.get_param('~image_sub_topic_name', default='/camera/rgb/image_raw')
    ...
    def run(self,
        ...
        if not self.use_compressed_image:
            ...
            rospy.Subscriber("/pcl_table", pc2.PointCloud2, self.pcl_callback, queue_size=1)
        else:
