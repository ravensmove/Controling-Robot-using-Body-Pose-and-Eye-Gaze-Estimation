            ...
            for key, val in person.iteritems():
                for e in range(len(val)):
                    ...
                    if key == 'left_eye' or key == 'right_eye':
                        eye.append(val[e])
                    #SHOULDER TO NECK TO SHOULDER
                    # if key == 'left_shoulder' or key == 'neck':
                    #     leftshoulderneck.append(val[e])
                    # if key == 'right_shoulder' or key == 'neck':
                    #     rightshoulderneck.append(val[e])

                    if key == 'left_shoulder' or key == 'left_elbow':
                        leftshoulderelbow.append(val[e])
                    if key == 'left_elbow' or key == 'left_wrist':
                        leftelbowwrist.append(val[e])
                    if key == 'right_shoulder' or key == 'right_elbow':
                        rightshoulderelbow.append(val[e])
                    if key == 'right_elbow' or key == 'right_wrist':
                        rightelbowwrist.append(val[e])
            length = math.sqrt((int(rightelbowwrist[1]) - int(rightelbowwrist[3])) * (int(rightelbowwrist[1]) - int(rightelbowwrist[3])) + (int(rightelbowwrist[0]) - int(rightelbowwrist[2])) * (int(rightelbowwrist[0]) - int(rightelbowwrist[2])))
            dx = (int(rightelbowwrist[1]) - int(rightelbowwrist[3])) / length
            dy = (int(rightelbowwrist[0]) - int(rightelbowwrist[2])) / length
            xnew = int(rightelbowwrist[1]) + length * dx
            ynew = int(rightelbowwrist[0]) + length * dy
            # print str(xnew) +"\t"+ str(ynew) 164 134

            for key, val in person.iteritems():
                cv.line(canvas, (int(eye[0]), int(eye[1])), (int(eye[2]), int(eye[3])), (255, 0, 0), 5)
                cv.line(canvas, (int(leftshoulderelbow[0]), int(leftshoulderelbow[1])), (int(leftshoulderelbow[2]), int(leftshoulderelbow[3])), (255, 0, 0), 5)
                cv.line(canvas, (int(leftelbowwrist[0]), int(leftelbowwrist[1])), (int(leftelbowwrist[2]), int(leftelbowwrist[3])), (255, 0, 0), 5)
                cv.line(canvas, (int(rightshoulderelbow[0]), int(rightshoulderelbow[1])), (int(rightshoulderelbow[2]), int(rightshoulderelbow[3])), (255, 0, 0), 5)
                cv.line(canvas, (int(rightelbowwrist[0]), int(rightelbowwrist[1])), (int(rightelbowwrist[2]), int(rightelbowwrist[3])), (255, 0, 0), 5)
                cv.line(canvas, (int(rightelbowwrist[0]), int(rightelbowwrist[1])),(int(ynew), int(xnew)), (255, 0, 0), 5)
